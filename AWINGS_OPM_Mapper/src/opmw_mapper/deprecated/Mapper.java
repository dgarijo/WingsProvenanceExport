...
//        String queryToolsUsed = opmw_mapper.Queries.queryUsedTools();        
//        //we need the template name to reference the nodes in the wf exec.        
...
//            currTool = (ArrayList) tools.get(i);
...
//                artifactID = MD5.MD5(location.getURI());
//            } catch (Exception ex) {
//                System.out.println("Error while trying to make MD5 key "+ex.getMessage());
